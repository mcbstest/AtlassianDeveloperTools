...
fun main(args : Array<String>) {
    ...
    issueList.forEach { e ->
        if ( !exceptionArray.contains(e) ) {
            ...
            componentList.forEach { c ->
                ...
                if ((c.toUpperCase() == component.toUpperCase()) || (c == "ABRMS (unspez.)") || (c == "Microservices") ) {
    ...
    logger.debug("Semantic version s : $semVerList")
    val s : String
    s = when {
    ...
    val g = GeneralInfo()
    val v = g.createNewMCBSComponentVersion(version , s )
    logger.info("=========================")
