 ...
 * @param [milestone] der zu suchende Milestone
...
fun main(args : Array<String>) {
    ...
    // Milestones
    val milestoneId: String = t.getMilestoneByName(projectId,milestone)
    // Update
    t.setMilestone(testrunId,milestoneId)
